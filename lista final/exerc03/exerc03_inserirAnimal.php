...
<html lang="pt-br">
        ...
        <div class="container">
            <div class="box">            
                ...
                <div class="account-wall">
                    <form action="exerc03_inserirAnimal.php" class="form-signin" method="POST">
    ...
    <?php
        ...
        if(isset($_POST["nome"]))
        {
            ...
            $aux[] = $a;
            $_SESSION["animalSession"][] = "Nome: {$aux[0]->nome}, Raça: {$aux[0]->raca} e Idade: {$aux[0]->idade}";
            ...
            echo  "<a href='./exerc03_listagem.php' class='btn btn-dark btn-lg btn-block' type='submit' > Listagem";
            echo "</a>";
            echo "</div>";
            echo "</div>";
            echo "</div>";
